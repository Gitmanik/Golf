...
public class Loader : MonoBehaviour
{
    ...
    readonly string[] Levels = { "DyniowyPoziom", "Level1", "Level2", "KaczyPoziom" };
    ...
    private IEnumerator IELoadLevel(string name)
    {
        ...
        {
            var x1 = SceneManager.UnloadSceneAsync(CurrentLevel);
            yield return x1;
        }
        ...
        BallController.Instance.transform.position = GameObject.Find("SpawnPosition").transform.position + Vector3.up * 10;
        BallController.Instance.Setup();
        BallController.Instance.GetComponent<TrailRenderer>().Clear();
    }
